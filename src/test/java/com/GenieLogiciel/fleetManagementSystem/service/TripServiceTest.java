...
class TripServiceTest {
    ...
    public void testSaveTripSuccess() {
        ...
        TripService tripService = new TripService(tripRepository, driverRepository);

        Trip validTrip = createValidTripWithDriver();
        when(driverRepository.existsById(validTrip.getDriver().getMatricule())).thenReturn(true); // Mock driver existence check
    ...
    public void testSaveTripException() {
        // Arrange
        Trip trip = createValidTripWithDriver();
